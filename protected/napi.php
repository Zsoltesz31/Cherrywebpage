...
<?php
$query="SELECT gyumolcs_tip,terulet,fajta,szedes_mod,raklap.rekesz_fajta,SUM(raklap.rekesz_db) as DB, SUM(raklap.suly) as suly FROM szallitas JOIN raklap ON (szallitas.id = raklap.szallitas_id) GROUP BY gyumolcs_tip,terulet,fajta,rekesz_fajta,szedes_mod";
